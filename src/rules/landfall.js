...
export function installLandfall(registry) {
  ...
  register(registry, 'Cultivator Colossus', { characteristics: (g, o, c) => { c.power = countType(g, 'Land', o.controller); c.toughness = c.power; }, triggers: [etb('colossus', 'Put a land, draw, and repeat', () => [{ op: 'call', handler: 'landfall.colossus' }])] });
