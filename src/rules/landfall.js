...
export function installLandfall(registry) {
  ...
  register(registry, 'Tireless Provisioner', { triggers: [landfall('provision', 'Create a Treasure or Food', () => [{ op: 'choose', key: 'tokenKind', label: 'Create Treasure or Food', options: options(['Treasure', 'Food']), policyKey: 'token-kind', legacyDefaultValue: 'Treasure' }, { op: 'token', card: '$var.tokenKind' }])] });
