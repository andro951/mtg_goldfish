...
require(engine_tests >= 430 and total('pass') == engine_tests, 'Engine acceptance is incomplete.')
...
require(browser.get('uiVersion') == '1.2.1', 'The tested UI must be the compact tabletop, not the retired interface.')
